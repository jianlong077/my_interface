...
public class Service implements Serializable {
    ...
    private String template_vm = "service.java.vm";

    public Service(BaseModle baseModle) {
        this.nameUppeCase = baseModle.getEntityName() + "Service";
        this.nameLowerCase = ToolUtil.FirstLowerCase(this.nameUppeCase);
        this.javaPathOut = baseModle.getBaseJavaPathOut() + "\\service\\" + baseModle.getEntityName() + "Service" + ".java";
        this.javaPathParent = baseModle.getBaseJavaPath() + ".service";
        this.javaPath = baseModle.getBaseJavaPath() + ".service." + baseModle.getEntityName() + "Service";
    }
